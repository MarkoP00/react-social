...
export default function InspectPostImages({
  images,
  closeEvent,
  ww,
  singleUser,
  ...
  return (
    <div
      ...
      className={`relative overflow-hidden ${
        ww ? `w-[${ww}px]` : "w-[650px]"
      } h-[60vh] max-w-4xl sm:h-[55vh] rounded-lg shadow-lg`}
      {...handlers}
    >
      <div
      ...
      {singleUser && (
        <div
          onClick={() => closeEvent(null)}
          className="absolute top-2 right-3 p-2 rounded-full bg-white/60 shadow-lg  hover:bg-white transition z-10"
        >
